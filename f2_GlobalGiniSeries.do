...
*** PREPARE DATA ***
********************
import excel "Inputdata\FigureData_chapter2.xlsx", sheet("Figure2.10") firstrow clear
rename Year year
...
drop H I J
export delimited "Outputdata/GlobalGiniSeries.csv", replace

********************
*** INTRODUCTION ***
********************
// This .do-file takes the Global Gini series from the 2022 Poverty and Shared Prosperity Report and slightly reformats the data for the Atlas.
// It also restricts the Gini series for a few countries from PIP
cd "C:\Users\WB514665\OneDrive - WBG\DECDG\SDG Atlas 2022\Ch10\playground-sdg-10"
